...
public class DatosCurricularesServiceImpl implements DatosCurricularesService {
    private final DatosCurricularesRepository repository;
    private final DemCondLabRepository demCondLabRepository;

    private final DemCondLabMapper mapper;

    public DatosCurricularesServiceImpl(DatosCurricularesRepository repository,
            DemCondLabRepository demCondLabRepository, DemCondLabMapper datosMapper) {
