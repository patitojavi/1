...
@Entity
@Table(name = "BNE_VEHICULOS")
public class BneVehiculos implements Serializable {
...
//    private List<OfeReqGenerales> ofeReqGeneralesesForIdVehiculo1 = new ArrayList<>(0);
//    private List<OfeReqGenerales> ofeReqGeneralesesForIdVehiculo2 = new ArrayList<>(0);
//    private List<DemVehiculos> demVehiculoses = new ArrayList<>(0);

    public BneVehiculos() {
    }

    public BneVehiculos(final Integer id) {
        this.id = id;
    }
