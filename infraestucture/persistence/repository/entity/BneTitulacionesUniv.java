...
@Entity
@Table(name = "BNE_TITULACIONES_UNIV", uniqueConstraints = @UniqueConstraint(columnNames = "CODIGO"))
public class BneTitulacionesUniv implements Serializable {
    ...
    public BneTitulacionesUniv() {
    }

    public BneTitulacionesUniv(final Integer id) {
        this.id = id;
    }
