...
@Entity
@Table(name = "BNE_ACT_ECONOMICA")
public class BneActEconomica implements Serializable {
...
//    private List<EmpEmpresario> empEmpresarios = new ArrayList<>(0);
//    private List<DemCondLab> demCondLabs = new ArrayList<>(0);
//    private List<EmpUbicacRelac> empUbicacRelacs = new ArrayList<>(0);

    public BneActEconomica() {
    }

    public BneActEconomica(final Integer id) {
        this.id = id;
    }
